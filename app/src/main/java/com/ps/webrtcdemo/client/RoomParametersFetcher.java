...
//            client_id   唯一------>  userId   建立p2p    文字      socket 进行        client_id
            String clientId = roomJson.getString("client_id");
            String wssUrl = roomJson.getString("wss_url");//ws://192.168.10.1
...
//            https://47.107.132.117/join/david3    iceServers:[]
            ...
            // Request TURN servers     isTurnPresent=false.
            if (!isTurnPresent) {
